...
{
    public partial class EcommerceWebAPPServiceModelsECOMContext : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProdName = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    ProdDetails = table.Column<string>(type: "nvarchar(50)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrdreOrderId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_Order_OrdreOrderId",
                        column: x => x.OrdreOrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_OrdreOrderId",
                table: "OrderDetails",
                column: "OrdreOrderId");
        }
